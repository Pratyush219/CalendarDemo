...
import com.example.calendardemo.adapter.EventAdapter;
...
public class UserFragment extends Fragment {
    ...
    EditText etDate, etStartTime, etEndTime;
...
//        credential.setSelectedAccountName(settings.getString(PREF_ACCOUNT_NAME, null));
        ...
        btnCreate.setOnClickListener(v -> {
            final Event[] event = {new Event()
                    .setSummary("SS&CD 2nd Lab internal")
                    .setLocation("Bangalore Institute of Technology, Bengaluru, India")
                    .setDescription("Attend the 2nd lab internal of SS&CD")};
        ...
        Toast.makeText(requireContext(), "Going for events", Toast.LENGTH_SHORT).show();
        service1.execute(() -> {
            Looper.prepare();
            try {
